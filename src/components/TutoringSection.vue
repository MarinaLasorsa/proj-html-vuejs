    ...
    <section class="tutoring-section">
        <div class="container">
            <div class="text-align-center">
                <p class="medium-font light-purple-font">MAXCOACH AVAILABLE COURSES</p>
                <h2 class="section-title">Access <span class="title-highlight">Smart Tutoring</span> Program For
                    Benefits.</h2>
            </div>
            <div class="row">
                <div class="col-4">
